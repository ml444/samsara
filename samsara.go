...
func NewSamsara(ringBufferSize int64) *Samsara {
	ringBuffer := internal.NewRingBuffer(ringBufferSize)
...
func (s *Samsara) Get(sequence int64) interface{} {
...
func (s *Samsara) NewSimpleSubscriber(strategy internal.ISubscriberStrategy, handler subscribe.Handler) subscribe.ISubscriber {
