...
type IScheduler interface {
	...
	GetBufferSize() int64
	GetIndexMask() int64
	SetEntity(index int64, entity entity.IEntity)
	GetEntity(seq int64) entity.IEntity
}
...
func (s *Scheduler) SetEntity(seq int64, entity entity.IEntity) {
	s.ringBuffer.SetEntity(seq, entity)
}
func (s *Scheduler) GetEntity(seq int64) entity.IEntity {
