...
type IPublishBarrier interface {
	...
	Commit(seq int64, entity entity.IEntity)
}
type ISubscribeBarrier interface {
	WaitFor(sequence int64) int64
	GetEntity(sequence int64) entity.IEntity
}
...
func (b *BasePublishBarrier) Commit(seq int64, entity entity.IEntity) {
...
func (b *MultiPublishBarrier) Commit(seq int64, entity entity.IEntity) {
	b.scheduler.SetEntity(seq, entity)
...
func (b *SubscribeBarrier) GetEntity(seq int64) entity.IEntity {
